        ...
        <div class="row">
            <div class="col-md-2 ct-left ">
                <div class="avatar">
                    ...
                    <p></p>
                    <Form action="{{url('diemhoctap')}}" method="post" style="padding: 10px">
                    <p class="name">
                        @foreach($post as $value){{$value}}<br>
                        @endforeach
                    </p>
                    <p class="id"></p>
                    {!! csrf_field() !!}
                ...
                <div class="under-avt">
                    <div class="btn-group-vertical">
                        ...
                        <button type="button" class="btn btn-primary accc" href="diemhoctap"><span><i class="fas fa-car"></i></span>&ensp;xem điểm học tập</button>
